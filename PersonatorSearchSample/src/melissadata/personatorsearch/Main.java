...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            this.primaryStage.setTitle("Personator Search Java Sample Application");

            initRootLayout();

            showPersonatorSearch();
        } catch(Exception e) {
            e.printStackTrace();
        }
    }
     ...
     */
    public void showPersonatorSearch() {
        try {
            ...
            rootLayout.setCenter(personatorSearch);

            // Give the controller access to the main app
            PersonatorSearchController controller = loader.getController();
            controller.setMainApp(this);
        } catch (IOException e) {
            e.printStackTrace();
        }
