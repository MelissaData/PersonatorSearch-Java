...
# Personator Search API JAVA REST Sample Code

This is a sample code for Melissa's Personator Search API. It is written in JAVA and accesses the API through REST. 
This sample is intended to show the functionality of the Personator Search Web Service and how to call the service in JAVA. 
...
* Run Windows Batch file (PersonatorSearchSample\src\Sample.bat) which will compile and run the Java Sample Code
